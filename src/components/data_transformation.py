...
class DataTransformation:
        ...
        try:
            ...
            cat_pipeline=Pipeline(
                steps=[
                    ...
                    ('scalaer',StandardScaler(with_mean=False))
                ]
            )
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Read the train and test data for data transformation completed")

            preprocessing_obj=self.get_data_transformaer_object()
            logging.info('preprocessor object fetching comleted')
